(function () {
  ...
  function bindOrganizer(subroute) {
    if (subroute === "events") {
      ...
      if (addBagItem) addBagItem.addEventListener("click", () => { state.event.bagItems.push(makeBagItem("New bag item")); saveState(); renderOrganizer("events"); });
